...
function newProject(): ClipShopProject {
  ...
  return { id: crypto.randomUUID(), name: "Novo projeto", productName: "", status: "draft", strategy: "balanced", quality: "performance", audioPolicy: { ...DEFAULT_AUDIO_POLICY }, audioShuffle: createDefaultAudioShuffleProjectState(), compositionMode: "contain", visualVariationsEnabled: true, mp4MetadataEnabled: true, exportNameTemplate: DEFAULT_EXPORT_NAME_TEMPLATE, clips: [], variations: [], createdAt: now, updatedAt: now };
}
