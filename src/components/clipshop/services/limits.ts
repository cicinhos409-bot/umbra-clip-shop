...
export const MAX_PROJECT_SOURCE_BYTES = 1500 * 1024 * 1024;
...
export function validateProjectFiles(currentBytes: number, incoming: File[]) {
  ...
  if (total > MAX_PROJECT_SOURCE_BYTES) return "O projeto excederia o limite de 1,5 GB em arquivos de origem.";
  return null;
}
