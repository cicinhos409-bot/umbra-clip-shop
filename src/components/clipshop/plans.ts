...
export const CLIP_SHOP_PLANS: Record<ClipShopPlanKey, ClipShopPlanDefinition> = {
  ...
  pro: { key: "pro", name: "Pro", monthlyVideos: 270, combinations: 27, batchSize: 5, description: "Para afiliados que publicam criativos toda semana." },
  elite: { key: "elite", name: "Elite", monthlyVideos: 470, combinations: 27, batchSize: 27, description: "Para operações que precisam produzir em maior escala." },
};
